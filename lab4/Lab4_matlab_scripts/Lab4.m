...
%This script will create a mosaic of a series of overlapping images
% Load images from the Matlab vision directory
% Forsyth Folder has distorted images of the murals on the latino centre
% Undistorted Folder has the undistorted images of murals on the latino
% centre
...
buildingDir = fullfile(toolboxdir('vision'), 'visiondata', 'UCinder');
buildingScene = imageDatastore(buildingDir);

imageSize = [300 300];
buildingScene.ReadFcn = @(buildingScene)imresize(imread(buildingScene),imageSize);
...
I = rgb2gray(I); 
[x,y,~] = harris(I,5000,'tile',[1 1],'disp');
points = [x y];
